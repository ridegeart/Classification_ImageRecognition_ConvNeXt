...
class HierarchicalLossNetwork:
    ...
    def __init__(self, metafile_data, hierarchical_labels_one,hierarchical_labels_two, device='cpu', total_level=2, alpha=1, beta=0.8, p_loss=3):
        '''Param init.
        '''
        ...
        self.level_one_labels, self.level_two_labels , self.level_third_labels =metafile_data['name1'],metafile_data['name2'],metafile_data['name3']
